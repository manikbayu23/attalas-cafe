...
<head>
    ...
    <title>Tidak Punya Akses - Attalas Cafe</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: radial-gradient(circle at top right, rgba(139, 90, 43, 0.22), transparent 55%), var(--attalas-cream-50);
            color: #1f2933;
            display: flex;
            align-items: center;
    ...
    <div class="error-wrapper">
        <div class="error-card">
            <div class="error-main">
                ...
                <div class="error-code">Akses ditolak.</div>
                <div class="error-title">Kamu tidak punya izin untuk membuka halaman ini.</div>
                <p class="error-text">
                    Hak akses akunmu tidak mencukupi untuk melihat halaman ini. Jika menurutmu ini adalah kesalahan,
                    hubungi administrator Attalas Cafe.
                </p>
            ...
            <aside class="error-aside">
                ...
                <p class="error-quote">
                    "Tidak semua pintu Attalas terbuka untuk semua orang. Beberapa butuh kunci khusus."
